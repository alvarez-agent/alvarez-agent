...
Usage:
    alvarez pairing list              # Show all pending + approved users
    alvarez pairing approve <platform> <code>  # Approve a pairing code
    alvarez pairing revoke <platform> <user_id> # Revoke user access
    alvarez pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle alvarez pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: alvarez pairing {list|approve|revoke|clear-pending}")
        print("Run 'alvarez pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.alvarez/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'alvarez pairing list' to see pending codes.\n")
