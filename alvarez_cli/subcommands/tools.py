"""``alvarez tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'alvarez tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # alvarez tools list [--platform cli]
    ...
    # alvarez tools disable <name...> [--platform cli]
    ...
    # alvarez tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `alvarez tools` runs after you pick a provider that\n"
