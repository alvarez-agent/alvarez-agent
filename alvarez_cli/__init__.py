"""
Alvarez CLI - Unified command-line interface for Alvarez Agent.

Provides subcommands for:
- alvarez chat          - Interactive chat (same as ./alvarez)
- alvarez gateway       - Run gateway in foreground
- alvarez gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `alvarez setup` on a fresh Pi.
    ...
    alvarez_cli/stdio.py::configure_windows_stdio() runs later from the entry
