"""Alvarez CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.alvarez/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Alvarez Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Alvarez "       # Response box header label
...
.. code-block:: python
    ...
    from alvarez_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Alvarez Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.alvarez/skins/
...
- ``paper``    — Traditional light: dark text, restrained indigo accent
- ``graphite`` — Traditional dark: neutral gray, calm blue accent
- ``hypercrush`` — Neon magenta/violet on tinted black
- ``terminal-acid`` — Electric green and cyan on black, CRT energy
- ``sunfire`` — Orange/red on near-black, heat and alarm
- ``deep-reef`` — Teal/violet on deep navy, vibrant but calm

USER SKINS
==========

Drop a YAML file in ``~/.alvarez/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ALVAREZ_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ALVAREZ_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Alvarez — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Alvarez Agent",
            "welcome": "Welcome to Alvarez Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Alvarez ",
            "prompt_symbol": "❯",
...
[dim #7A3511]⠀⠀⠀⠀⠀⠀⠀tail flame lit⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    # ponytail: the six themes below are color-only — spinner/branding/banners
    # inherit from "default" via _build_skin_config's merge.
    "paper": {
        "name": "paper",
        "description": "Traditional light — dark text, restrained indigo accent",
        "colors": {
            "banner_border": "#C9C9BF",
            "banner_title": "#23272E",
            "banner_accent": "#3D5AC9",
            "banner_dim": "#9AA0A6",
            "banner_text": "#3A3F46",
            "ui_accent": "#3D5AC9",
            "ui_label": "#6E7480",
            ...
            "prompt": "#23272E",
            "input_rule": "#C9C9BF",
            "response_border": "#3D5AC9",
            "status_bar_bg": "#ECECE5",
            "status_bar_text": "#23272E",
            "status_bar_strong": "#101317",
            "status_bar_dim": "#8A8F98",
            "status_bar_good": "#2E7D32",
            "status_bar_warn": "#B26A00",
            "status_bar_bad": "#C22F2F",
            "status_bar_critical": "#A01818",
            "session_label": "#3D5AC9",
            "session_border": "#C9C9BF",
        },
        "spinner": {},
    },
    "graphite": {
        "name": "graphite",
        "description": "Traditional dark — neutral gray, calm blue accent",
        "colors": {
            "banner_border": "#3A3F47",
            "banner_title": "#D7DAE0",
            "banner_accent": "#6C9EF8",
            "banner_dim": "#4A4F58",
            "banner_text": "#B7BCC4",
            "ui_accent": "#6C9EF8",
            "ui_label": "#8A8F98",
            ...
            "prompt": "#D7DAE0",
            "input_rule": "#3A3F47",
            "response_border": "#6C9EF8",
            "status_bar_bg": "#1D2026",
            "status_bar_text": "#D7DAE0",
            "status_bar_strong": "#F0F2F5",
            "status_bar_dim": "#6A707A",
            "status_bar_good": "#57AB5A",
            "status_bar_warn": "#C69026",
            "status_bar_bad": "#E5534B",
            "status_bar_critical": "#FF6B60",
            "session_label": "#8A8F98",
            "session_border": "#3A3F47",
        },
        "spinner": {},
    },
    "hypercrush": {
        "name": "hypercrush",
        "description": "Neon magenta and violet on tinted black — the loud one",
        "colors": {
            ...
            "prompt": "#F2ECFF",
            "input_rule": "#3B6CFF",
            "response_border": "#9D5CFF",
            "status_bar_bg": "#232331",
            "status_bar_text": "#F2ECFF",
            "status_bar_strong": "#FF2AD4",
            "status_bar_dim": "#6E679A",
            "status_bar_good": "#3DDC97",
            "status_bar_warn": "#FFB02E",
...
[#3B6CFF]╚═╝  ╚═╝╚══════╝  ╚═══╝  ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝[/]""",
    ...
    "terminal-acid": {
        "name": "terminal-acid",
        "description": "Electric green and cyan on black — CRT energy",
        "colors": {
            "banner_border": "#1E7A3C",
            "banner_title": "#39FF14",
            ...
            "status_bar_bg": "#0B120D",
            "status_bar_text": "#C8FFD4",
            "status_bar_strong": "#39FF14",
            "status_bar_dim": "#3F8A5F",
            "status_bar_good": "#39FF14",
            "status_bar_warn": "#E8FF3A",
            "status_bar_bad": "#FF3366",
            "status_bar_critical": "#FF0044",
            "session_label": "#00E5FF",
            "session_border": "#1E5A34",
        },
        "spinner": {},
    },
    "sunfire": {
        "name": "sunfire",
        "description": "Orange and red on near-black — heat and alarm",
        "colors": {
            "banner_border": "#A83A10",
            "banner_title": "#FF6B1A",
            "banner_accent": "#FF3524",
            # Bumped from #7A3511 (~28% luminance) — unreadable on the
            # near-black bg, and Rich's [dim] modifier darkens it further.
            # ~60% luminance keeps the burnt-orange "muted" semantic legible
            # (same treatment as the gold theme's muted in ui-tui/theme.ts).
            "banner_dim": "#CE7B3E",
            "banner_text": "#FFE8D6",
            "ui_accent": "#FF6B1A",
            "ui_label": "#FFA45C",
            ...
            "prompt": "#FFE8D6",
            "input_rule": "#A83A10",
            "response_border": "#FF6B1A",
            "status_bar_bg": "#1D0F08",
            "status_bar_text": "#FFE8D6",
            "status_bar_strong": "#FF6B1A",
            "status_bar_dim": "#C08558",
            "status_bar_good": "#7BC96F",
            "status_bar_warn": "#FFB02E",
            "status_bar_bad": "#FF3524",
            "status_bar_critical": "#FF1A1A",
            "session_label": "#FFA45C",
            "session_border": "#CE7B3E",
        },
        "spinner": {},
    },
    "deep-reef": {
        "name": "deep-reef",
        "description": "Teal and violet on deep navy — vibrant but calm",
        "colors": {
            "banner_border": "#23508F",
            "banner_title": "#2DD4BF",
            ...
            "prompt": "#DCEBFF",
            "input_rule": "#23508F",
            "response_border": "#8B5CF6",
            "status_bar_bg": "#101A33",
            "status_bar_text": "#DCEBFF",
            "status_bar_strong": "#2DD4BF",
            "status_bar_dim": "#6C82A6",
            "status_bar_good": "#34D399",
            "status_bar_warn": "#F5A623",
            "status_bar_bad": "#FF5C7A",
            "status_bar_critical": "#FF3B60",
            "session_label": "#4C8DFF",
            "session_border": "#2B3B5E",
        },
        "spinner": {},
    },
}
