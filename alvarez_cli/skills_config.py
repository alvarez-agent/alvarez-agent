"""
Skills configuration for Alvarez Agent.
`alvarez skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.alvarez/config.yaml under:
...
from alvarez_cli.config import cfg_get, load_config, save_config
from alvarez_cli.colors import Colors, color
from alvarez_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `alvarez skills`."""
    from alvarez_cli.curses_ui import curses_checklist
