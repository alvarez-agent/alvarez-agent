...
def _has_alvarez_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ALVAREZ_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-AlvarezHome", str(get_alvarez_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = alvarez_subprocess_env(inherit_credentials=False)
