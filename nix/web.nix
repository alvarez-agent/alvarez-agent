# nix/web.nix — Alvarez Web Dashboard (Vite/React) frontend build
{ pkgs, alvarezNpmLib, ... }:
let
  npm = alvarezNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "alvarez-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../alvarez_cli/web_dist for the
