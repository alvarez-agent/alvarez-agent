...
def _policy_url(relay_dial_url: str) -> str:
    ...
    Rewrites the ws(s) scheme to http(s) and swaps the ``/relay`` path for
    ``/relay/policy``; the connector mounts the relevance-policy update channel
    there (Phase 6 Unit ζ).
    """
