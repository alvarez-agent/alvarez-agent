...
Hooks are discovered from ~/.alvarez/hooks/ directories, each containing:
...
HOOKS_DIR = get_alvarez_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"alvarez_hook_{hook_name}"
