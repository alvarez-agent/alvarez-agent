...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ALVAREZ_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_alvarez_dir("platforms/whatsapp/session", "whatsapp/session")
