...
# Other display settings (compact, mood, skin, etc.) are CLI-only
...
_PLATFORM_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    # "new"/"all" spam permanent lines in channels (alvarez-agent#14663).
    ...
    # Alvarez Cloud adapter doesn't implement edit_message yet, so we
