...
```bash
python3 -m pyfiglet "ALVAREZ" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ALVAREZ&font=Slant" | boxes -d stone
```
