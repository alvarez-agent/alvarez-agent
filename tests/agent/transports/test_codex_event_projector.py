"""Tests for CodexEventProjector — codex item/* events → Alvarez messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Alvarez' message alternation invariant."""
