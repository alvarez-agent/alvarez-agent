...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated ALVAREZ_HOME, yield (agent, helpers)."""
    ...
    test_home = tempfile.mkdtemp(prefix="alvarez_e2e_47967_")
    os.makedirs(os.path.join(test_home, ".alvarez"))
    prev_home = os.environ.get("ALVAREZ_HOME")
