...
thinking phase.  Alvarez's default cloud-stream stale detector
(``ALVAREZ_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ALVAREZ_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
