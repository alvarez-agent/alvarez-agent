...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_alvarez_user(self):
        """Without user_id or config override, should default to 'alvarez-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "alvarez-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"ALVAREZ_HOME": "/tmp/test_alvarez"}):
