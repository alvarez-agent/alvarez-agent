...
The unit tests in tests/alvarez_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned alvarez-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/alvarez")
from alvarez_cli.service_manager import S6ServiceManager
