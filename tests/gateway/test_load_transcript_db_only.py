...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.alvarez/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at alvarez_state import time, before pytest's ALVAREZ_HOME monkeypatch
    fires — the autouse fixture's ALVAREZ_HOME override doesn't help here.)
    """
