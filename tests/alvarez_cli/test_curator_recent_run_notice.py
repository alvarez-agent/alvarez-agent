...
The notice prints the most recent curator run summary on `alvarez update`,
...
session start) so users normally never see the rename map. `alvarez update`
