"""Tests for the specifier module + `alvarez kanban specify` CLI surface.
...
from alvarez_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `alvarez kanban …` argparse surface directly."""
