"""Tests for the ``alvarez prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from alvarez_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(alvarez_home, memory_text="", user_text=""):
    mem_dir = alvarez_home / "memories"
...
def _seed_skill(alvarez_home, name, description):
    skill_dir = alvarez_home / "skills" / "demo" / name
