...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from alvarez_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ALVAREZ_OVERLAYS
        overlay = ALVAREZ_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify alvarez doctor recognizes Xiaomi env vars."""
