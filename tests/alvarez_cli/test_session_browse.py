"""Tests for the interactive session browser (`alvarez sessions browse`).
...
from alvarez_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """alvarez sessions browse should be parseable."""
