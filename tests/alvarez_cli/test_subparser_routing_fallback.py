...
The main() function in alvarez_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `alvarez -c model`
...
def _build_parser():
    """Build a minimal replica of the alvarez top-level parser."""
