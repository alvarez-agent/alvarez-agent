...
def worker_loop(worker_id: int, alvarez_home: str, result_file: str) -> None:
...
def reclaimer_loop(alvarez_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="alvarez_mixed_stress_")
    print(f"ALVAREZ_HOME = {home}")
