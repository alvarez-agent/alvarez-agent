...
Tests cover:
- managed_nous_tools_enabled() dead-False shim (managed gateway removed)
...
# ---------------------------------------------------------------------------
# managed_nous_tools_enabled / gateway-unavailable message (shims)
# ---------------------------------------------------------------------------
class TestManagedToolsShims:
    """The managed tool gateway was removed; the predicate is a dead-False
    shim and the message points users at direct API keys."""
