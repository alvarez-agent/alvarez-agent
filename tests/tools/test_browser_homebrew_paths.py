...
class TestRunBrowserCommandPathConstruction:
    ...
    def test_subprocess_preserves_executable_path_with_spaces(self, tmp_path):
        ...
        browser_path = "/Users/test/Library/Application Support/alvarez/node_modules/.bin/agent-browser"
        alvarez_home = str(tmp_path / "alvarez-home")
 ...
 patch("tools.browser_tool._chromium_installed", return_value=True), \
             ...
             patch("alvarez_constants.Path.home", return_value=tmp_path), \
