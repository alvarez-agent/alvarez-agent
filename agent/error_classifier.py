...
#
# See: upstream hermes-agent issue #27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic) run before
    ...
    if status_code == 404:
        # Some providers surface credit depletion as a paid model becoming
