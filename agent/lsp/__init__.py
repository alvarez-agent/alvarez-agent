"""Language Server Protocol (LSP) integration for Alvarez Agent.

Alvarez runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``alvarez chat`` exit would leak pyright processes that
