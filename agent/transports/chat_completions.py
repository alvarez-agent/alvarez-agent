...
providers (OpenRouter, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Alvarez/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Alvarez'
    ...
    # is stricter (low/high). Clamp Alvarez' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Alvarez-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Alvarez-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (OpenRouter,
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            # This happens when a profile that emits extra_body is active
            # but the resolved endpoint is a Gemini base_url — typical when only Google credentials are set and
