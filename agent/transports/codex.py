...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Alvarez's web-provider config and
        ...
        # native search engine for xAI sessions instead of Alvarez's
        # configured web provider (Tavily/etc.), and those results bypass
        # Alvarez's tool-trace / citation plumbing (they arrive baked into the
