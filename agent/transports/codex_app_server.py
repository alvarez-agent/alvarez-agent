...
projection into Alvarez' display, approval bridging, transcript projection into
...
"codex_app_server"`. Alvarez' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("ALVAREZ_KANBAN_TASK"):
            kanban_db = spawn_env.get("ALVAREZ_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "ALVAREZ_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("ALVAREZ_HOME", os.path.expanduser("~/.alvarez")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "alvarez",
        client_title: str = "Alvarez Agent",
