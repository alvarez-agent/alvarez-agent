...
def _profile_user_agent() -> str:
    """Return a ``alvarez-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from alvarez_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"alvarez-cli/{_ver}"
    except Exception:
        return "alvarez-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # alvarez-cli UA so the catalog endpoint is reachable.
