"""
Cron job scheduling system for Alvarez Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    alvarez gateway install    # Install as a user service
    sudo alvarez gateway install --system  # Linux servers: boot-time system service
    alvarez gateway            # Or run in foreground
