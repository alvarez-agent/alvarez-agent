# Streaming LLM Response Support for Alvarez Agent
...
```
ALVAREZ_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ALVAREZ_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `alvarez_cli/config.py` | 1 | +streaming config defaults |
...
ALVAREZ_STREAMING_ENABLED=true
```
