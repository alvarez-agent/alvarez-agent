#!/usr/bin/env python3
"""Build the Alvarez Skills Index — a centralized JSON catalog of all skills.
...
`alvarez skills search/install` can use it without hitting the GitHub API.
...
# Ensure ALVAREZ_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Alvarez Skills Index...", flush=True)
