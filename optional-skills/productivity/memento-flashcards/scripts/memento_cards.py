...
Data file: $ALVAREZ_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ALVAREZ_HOME = Path(os.environ.get("ALVAREZ_HOME", Path.home() / ".alvarez"))
DATA_DIR = _ALVAREZ_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
