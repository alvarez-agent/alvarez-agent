...
version: 1.0.1
author: Joe Rinaldi Johnson (joerj123), Alvarez Agent
license: MIT
...
| Telegram (Alvarez Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
