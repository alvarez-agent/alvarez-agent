...
4. Name the token (e.g., "Alvarez Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${ALVAREZ_HOME:-~/.alvarez}/.env`:
...
```bash
CANVAS="python $ALVAREZ_HOME/skills/productivity/canvas/scripts/canvas_api.py"
