...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Alvarez Agent
license: MIT
...
Helper script path: `~/.alvarez/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.alvarez/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.alvarez/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.alvarez/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
