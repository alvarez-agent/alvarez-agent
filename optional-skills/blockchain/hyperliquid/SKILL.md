...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Alvarez Agent
license: MIT
...
The script reads `${ALVAREZ_HOME:-~/.alvarez}/.env` for two optional defaults:
...
Helper script: `~/.alvarez/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.alvarez/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ALVAREZ_HOME:-~/.alvarez}/.env`.
...
```bash
python3 ~/.alvarez/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.alvarez/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
