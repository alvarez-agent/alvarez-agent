...
```python
import sys
sys.path.insert(0, "/home/teknium/.alvarez/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.alvarez/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Alvarez installs package this)
