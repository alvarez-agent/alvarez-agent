...
version: 0.1.0
author: Mibay (Mibayy), Alvarez Agent
license: MIT
...
```
SCRIPT=~/.alvarez/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.alvarez/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
