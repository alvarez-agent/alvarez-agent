...
author: Alvarez Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  alvarez:
...
# $ALVAREZ_OSINT_CACHE/icij/ (default: ~/.cache/alvarez-osint/icij/).
...
# Set ALVAREZ_OSINT_UA=your-app/1.0 (your@email) to identify yourself
