...
DEFAULT_UA = (
    "alvarez-osint-investigation/0.2 "
    "(+alvarez-agent; "
    "set ALVAREZ_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("ALVAREZ_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
