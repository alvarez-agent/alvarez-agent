...
- User wants **Alvarez itself to drive a browser** → use Alvarez' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
