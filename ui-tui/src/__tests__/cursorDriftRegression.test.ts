 ...
 *
 * Symptom: in `alvarez --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@alvarez/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using alvarez --tui and as i type multiline my caret at the end will often ' +
