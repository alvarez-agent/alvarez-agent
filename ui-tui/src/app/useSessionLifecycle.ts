...
import type { ScrollBoxHandle } from '@alvarez/ink'
import { evictInkCaches } from '@alvarez/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ALVAREZ_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
