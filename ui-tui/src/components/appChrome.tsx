import { Box, type ScrollBoxHandle, stringWidth, Text } from '@alvarez/ink'
...
// Colour a notice by its level. The notice TEXT already carries its
...
export function StatusRule({
  ...
  // A notice replaces the status/verb slot, but only when idle —
