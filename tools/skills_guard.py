...
Trust levels:
  - builtin:   Ships with Alvarez. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.alvarez/\.env|\~/\.alvarez/\.env',
     "alvarez_env_access", "critical", "exfiltration",
     "directly references Alvarez secrets file"),
    ...
    (r'\.alvarez/config\.yaml|\.alvarez/SOUL\.md',
     "alvarez_config_mod", "critical", "persistence",
     "references Alvarez configuration files directly"),
...
# scan. `.skillignore` is the Alvarez-native name; `.clawhubignore` is honored
